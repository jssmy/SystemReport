...
<body>    
        ...
        <div id="page-wrapper">
          ...
          <div class="panel panel-default">
                        ...
                        <div id="panel-chart" class="panel-body">
                            <div id="bar-chart-requerimiento"></div>
                        </div>
                        <div class="col-md-12">
    ...
    function get_chart(){
        ...
        $.ajax({
            url: "chart_report?action=chart_requerimiento&index="+$.urlParam("index"),
            method: "get",
            ...
            success: function(date){
               pagination(date.size);
                ...
                var bar = new Morris.Bar({
                  element: 'bar-chart-requerimiento',
                  resize: true,
                  data: date.data,
    ...
    function get_chart_date(){
        $("#panel-chart").html("<div id='bar-chart-requerimiento'></div>");
        get_chart();
