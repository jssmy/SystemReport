...
<body>    
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
          ...
          <div class="panel panel-default">
                        ...
                        <div id="bar-name" class="panel-heading">Resultados de mes</div>
                        <!-- /.panel-heading -->
                        <div id="panel-chart" class="panel-body">
                            <div id="line-chart-group"></div>
                        </div>
                        <div class="col-md-12">
    ...
    function get_chart(){
        ...
        $.ajax({
            url: "chart_report?action=atencion_group",
            method: "get",
            data: $("#form-date").serialize(),
            success: function(date){
              // alert(date);
                var bar = new Morris.Bar({
                  element: 'line-chart-group',
                  resize: true,
                  data: date,
                  barColors: ['#3FD14E', '#4336CE'],
                  xkey: 'grupo',
    ...
    function get_chart_date(){
        $("#panel-chart").html("<div id='line-chart-group'></div>");
        get_chart();
