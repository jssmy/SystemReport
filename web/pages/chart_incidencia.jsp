...
<body>    
        ...
        <div id="page-wrapper">
          ...
          <div class="panel panel-default">
                        ...
                        <div id="panel-chart" class="panel-body">
                            <div id="bar-chart-incidencia"></div>
                            <div class="col-md-12">
    ...
    <script>
        ...
        function get_chart(){
            ...
            $.ajax({
                url: "chart_report?action=chart_incidencia&index="+$.urlParam("index"),
                method: "get",
                ...
                success: function(date){
                   pagination(date.size);
                    ...
                    var bar = new Morris.Bar({
                      element: 'bar-chart-incidencia',
                      resize: true,
                      data: date.data,
                      barColors: ['#230094', '#4336CE'],
                      xkey: 'name',
                      ykeys: ['cantidad'],
                      labels: ['Incidencias'],
                      hideHover: 'auto',
        ...
        $("#panel-chart").html("<div id='bar-chart-incidencia'></div>");
        get_chart();
        }
